...
export class StudentService {
  ...
  private API_URL="http://localhost:4000/studentList";
  ...
  save(item: Student): Observable<Student> {
    return this.httpClient.post<Student>(this.API_URL, item);
  }
  ...
  update(id: number, item: Student): Observable<Student> {
    return this.httpClient.put<Student>(`${this.API_URL}/${id}`, item);
  }
